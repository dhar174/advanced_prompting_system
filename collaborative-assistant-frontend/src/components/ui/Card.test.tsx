...
describe('Card Components', () => {
  describe('Card', () => {
    ...
    it('applies custom className', () => {
      ...
      expect(screen.getByText('Child content').parentElement).toHaveClass('custom-card');
    });
  ...
  describe('CardContent', () => {
    ...
    it('applies custom className', () => {
      ...
      expect(screen.getByText('Main content').parentElement).toHaveClass('custom-content');
    });
  });
